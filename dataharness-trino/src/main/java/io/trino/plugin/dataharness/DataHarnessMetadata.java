...
public class DataHarnessMetadata implements ConnectorMetadata {
    ...
    private String buildKafkaQuery(org.dataharness.proto.KafkaSourceMessage kafkaSource, String columnList) {
    ...
    private String buildIcebergQuery(org.dataharness.proto.IcebergSourceMessage icebergSource, String columnList) {
        return String.format(
